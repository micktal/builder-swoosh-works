...
export default function Formations() {
  ...
  const allModules = [
    {
      ...
      d: "Communication assertive.",
      domain: "Communication",
      level: "Essentiel",
      duration: 20,
      langs: ["FR", "EN"],
      points: [
        "Accueillir et désamorcer l'émotion",
        "Reformuler et cadrer",
        "Proposer une solution et conclure",
      ],
    },
    {
      t: "Réagir face à une situation suspecte",
      d: "Sûreté et vigilance.",
      domain: "Sûreté",
      level: "Intermédiaire",
      duration: 25,
      langs: ["FR"],
      points: [
        ...
        "Se mettre à couvert / sécuriser",
      ],
    },
    {
      t: "Prévenir les RPS au quotidien",
      d: "Signaux faibles et action.",
      domain: "RPS",
      level: "Essentiel",
      duration: 18,
      langs: ["FR", "EN"],
    ...
    {
      t: "Santé au travail : mieux gérer le stress",
      d: "Régulation & bien‑être.",
      domain: "Bien‑être",
      level: "Essentiel",
      duration: 15,
      langs: ["FR", "EN", "ES"],
      points: [
        ...
        "Techniques de respiration et priorisation",
        "Plan individuel de régulation",
      ],
    },
    {
      t: "Culture sécurité : adopter les bons réflexes",
      d: "Sensibilisation.",
      ...
      points: [
        ...
        "Remonter les quasi‑accidents",
        "Animer des rituels prévention",
      ],
    },
  ];
  ...
  const filtered = useMemo(() => {
    return allModules.filter((m) => {
      ...
      const passSearch =
        !s || m.t.toLowerCase().includes(s) || m.d.toLowerCase().includes(s);
    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-[#0E1E2B] text-white section-y">
        <div className="absolute inset-0 -z-10">
          <img
            src={heroImg}
            alt="Collaborateurs en formation digitale"
        ...
        <div className="container-padded py-10 md:py-16">
          <Reveal>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold leading-tight">
              Nos formations e-learning, prêtes à déployer.
            </h1>
          </Reveal>
          <Reveal delay={80}>
            <p className="mt-3 max-w-3xl text-white/80">
              Des modules interactifs et mesurables pour développer les
              compétences humaines au cœur de la sécurité.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="bg-[#F9FAFB] section-y" id="categories">
        <div className="container-padded py-8 md:py-12">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              {
                t: "Comportement & Management",
                d: "Leadership, communication, gestion d’équipe.",
                icon: Users2,
              },
              {
                t: "Sécurité / Sûreté",
                d: "Réflexes, vigilance, comportement en situation.",
                icon: ShieldCheck,
              },
              {
                t: "Culture Prévention",
                d: "Responsabilité collective et anticipation des risques.",
                icon: AlertTriangle,
              },
              {
                t: "Accueil & Posture professionnelle",
                d: "Image, attitude et relation client.",
                icon: Handshake,
              },
              {
                t: "Gestion de crise / Communication",
                d: "Réagir efficacement sous pression.",
                icon: Megaphone,
              },
              {
                t: "Santé & Bien-être au travail",
                d: "Prévention des RPS, équilibre et résilience.",
                icon: HeartPulse,
              },
            ].map((c, i) => (
        ...
        <div className="container-padded py-8 md:py-12">
          ...
          <Reveal delay={80}>
            <p className="mt-2 text-muted-foreground">
              Recherchez et filtrez par domaine, niveau et durée.
            </p>
          </Reveal>
          <div className="mt-6 grid gap-3 md:grid-cols-4">
            <input
              ...
              className="rounded-[8px] border px-3 py-2 md:col-span-2"
              value={search}
        ...
        <div className="container-padded py-8 md:py-12">
          ...
          <Reveal delay={80}>
            <p className="mt-3 max-w-3xl text-muted-foreground">
              Chaque formation FPSG associe scénarisation, interactivité et
              ancrage mémoriel pour maximiser l’apprentissage.
            </p>
          </Reveal>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              {
                t: "Scénarios interactifs",
                d: "Cas concrets et mises en situation réelles.",
                icon: PlayCircle,
              },
              {
                t: "Feedback immédiat",
                d: "Évaluations intégrées et retours dynamiques.",
                icon: BadgeCheck,
              },
              {
                t: "Progression guidée",
                d: "Parcours structuré avec la taxonomie de Bloom.",
                icon: GraduationCap,
              },
            ].map((f, i) => (
      ...
      <section className="bg-white section-y">
        <div className="container-padded py-8 md:py-12">
          <Reveal>
            <h2 className="text-3xl md:text-4xl font-heading font-bold">
              Pourquoi digitaliser vos formations ?
            </h2>
          </Reveal>
          <div className="mt-8 grid gap-8 md:grid-cols-3">
            {[
              {
                t: "Rapidité de déploiement",
                d: "Mise en ligne en moins de 30 jours.",
                icon: Rocket,
              },
              {
                t: "Mesure du ROI",
                d: "Suivi en temps réel et indicateurs d’impact.",
                icon: BarChart3,
              },
              {
                t: "Scalabilité multilingue",
                d: "Déploiement international, plusieurs langues.",
                icon: Languages,
              },
            ].map((a, i) => (
