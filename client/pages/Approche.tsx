...
export default function Approche() {
  const heroVideo =
    "https://cdn.coverr.co/videos/coverr-working-in-the-office-7935/1080p.mp4";
  const heroPoster =
    ...
    <main>
        ...
        <div className="container-padded py-10 md:py-16">
          ...
          <Reveal delay={100}>
            <p className="mt-4 text-lg md:text-xl text-white/80">
              De la salle au digital, FPSG transforme la formation en expérience
              apprenante.
            </p>
          </Reveal>
        </div>
            ...
            <div className="grid gap-10 md:grid-cols-4">
              {[
                ...
                },
                {
                  ...
                  d: "Structurer du savoir à la maîtrise.",
                  icon: BookOpenCheck,
                },
                {
                  t: "Diffusion multilingue & déploiement",
                  d: "Tous supports, plusieurs langues.",
                  icon: Languages,
                },
                {
                  t: "Suivi & mesure du ROI",
                  d: "Complétion, réussite, export.",
                  icon: BarChart3,
                },
              ].map((s, i) => (
      ...
      <section className="bg-white section-y">
        <div className="container-padded section-y">
          <Reveal>
            <h2 className="text-3xl md:text-4xl font-heading font-bold">
              De votre document à un module e‑learning
            </h2>
          </Reveal>
                  ...
                  <AspectRatio ratio={16 / 9}>
                    <div className="absolute inset-0 grid place-items-center bg-gradient-to-br from-zinc-100 to-zinc-200 rounded-[8px]">
                      <div className="relative w-[82%] h-[82%] bg-white rounded-md shadow-xl overflow-hidden">
                        <div className="absolute right-3 top-3 text-[10px] font-semibold px-2 py-0.5 rounded bg-red-50 text-red-700 border border-red-200">
                          PDF
                        </div>
                ...
                <TabsContent value="pptx" className="mt-4">
                  <AspectRatio ratio={16 / 9}>
                    <div className="absolute inset-0 grid place-items-center bg-gradient-to-br from-orange-50 to-orange-100 rounded-[8px]">
                      <div className="relative w-[82%] h-[82%] bg-white rounded-md shadow-xl overflow-hidden">
                        <div className="absolute right-3 top-3 text-[10px] font-semibold px-2 py-0.5 rounded bg-orange-50 text-orange-700 border border-orange-200">
                          PPTX
                        </div>
            ...
            <div>
              <div className="space-y-4">
                <Reveal delay={40}>
                  <div className="card p-5">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Entretiens, objectifs pédagogiques, publics, contraintes.
                ...
                <Reveal delay={80}>
                  <div className="card p-5">
                    <div className="font-heading font-semibold">
                      2) Recherche & validation
                    </div>
                    <p className="text-sm text-muted-foreground mt-1">
                      Veille, sources internes/externes, conformité (sûreté,
                      HSE, RGAA). Validation avec vos experts.
                    </p>
                  </div>
                </Reveal>
                <Reveal delay={120}>
                  <div className="card p-5">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Charte, ton, cas métiers et vocabulaire interne.
                ...
                <Reveal delay={160}>
                  <div className="card p-5">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Storyboard, interactions, quiz, accessibilité, QA.
                      Packaging SCORM/xAPI et déploiement.
                    </p>
                  </div>
                </Reveal>
              </div>
      ...
      <section className="bg-[#F9FAFB] section-y">
        <div className="container-padded section-y">
          <Reveal>
            <h2 className="text-3xl md:text-4xl font-heading font-bold">
              Une pédagogie active et mesurable – le modèle Bloom
            </h2>
          </Reveal>
          <Reveal delay={80}>
            <p className="mt-3 max-w-3xl text-muted-foreground">
              Nos formations s’appuient sur la taxonomie de Bloom pour
              accompagner chaque apprenant dans un parcours progressif, du
              savoir à la compétence.
            </p>
          </Reveal>
          <div className="mt-10 grid gap-8 md:grid-cols-2 items-start">
            <div className="space-y-3">
              {[
                ...
                {
                  t: "Appliquer",
                  d: "Mettre en pratique dans des cas concrets.",
                },
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="card p-6">
              ...
              <p className="mt-1 text-muted-foreground">
                FR, EN, ES, DE… sous‑titres, voix‑off, contenus localisés.
              </p>
            </div>
            <div className="card p-6">
              <div className="h-10 w-10 rounded-full bg-primary/10 text-primary grid place-items-center">
              ...
              <p className="mt-1 text-muted-foreground">
                Ordinateur, mobile, tablette. Responsive et accessible.
              </p>
            </div>
            <div className="card p-6">
              <div className="h-10 w-10 rounded-full bg-primary/10 text-primary grid place-items-center">
              ...
              <p className="mt-1 text-muted-foreground">
                SCORM/xAPI, hébergement FPSG ou votre LMS, suivi et support.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                d: "Tableaux de bord interactifs.",
                icon: LineChart,
              },
              {
                t: "Indicateurs clés",
                d: "Réussite, temps, complétion.",
                icon: BarChart3,
              },
              {
                t: "Rapports exportables",
                d: "Données actionnables.",
                icon: FileDown,
              },
            ].map((c, i) => (
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2 items-center">
            ...
            <div>
              <p className="text-muted-foreground">
                Chaque module est conçu et validé par nos formateurs experts et
                ingénieurs pédagogiques. Le digital ne remplace pas l’humain :
                il le renforce.
              </p>
