...
const STEPS: Step[] = [
  {
    ...
    choices: [
      {
        id: "alerter",
        label: "Alerter et confiner selon la procédure",
        deltaStress: -10,
        good: true,
      },
      ...
      {
        id: "panique",
        label: "Courir vers la sortie en panique",
        deltaStress: 20,
      },
    ],
  },
  {
    ...
    choices: [
      {
        id: "calme",
        label: "Lui parler calmement, l'orienter vers la sortie",
        deltaStress: -8,
        good: true,
      },
      {
        id: "ignore",
        label: "L'ignorer pour gagner du temps",
        deltaStress: 10,
      },
  ...
  },
  {
    ...
    choices: [
      {
        id: "compter",
        label: "Vérifier les présents et remonter l'info",
        deltaStress: -6,
        good: true,
      },
      {
        id: "retour",
        label: "Retourner chercher un objet oublié",
        deltaStress: 18,
      },
    ...
    <Card className="h-full flex flex-col">
      <CardHeader>
        ...
        <CardTitle className="text-lg font-heading font-semibold break-words leading-snug">
          Simulation de crise – Réflexes essentiels
        </CardTitle>
        <CardDescription>
      ...
      <CardContent className="flex-1">
        ...
        {!done ? (
          ...
          <div className="mt-4">
            <Alert
              className={
                score >= 2 && stress <= 70 ? "border-green-500/50" : undefined
              }
            >
              <AlertTitle>Bilan</AlertTitle>
              <AlertDescription>
                Score: {score}/{STEPS.length} • Stress final: {stress}/100.{" "}
                {score >= 2 && stress <= 70
                  ? "Gestion de crise satisfaisante."
                  : "Rejouez pour optimiser vos réflexes."}
              </AlertDescription>
            </Alert>
          </div>
        )}
